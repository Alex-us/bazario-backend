...
import { generateAccessToken } from '../../authorization/services/accessTokenService';
...
import { sendActivationEmail } from '../../notifications/services/emailService';
import { IUser, UserBlockReasons } from '../../types';

jest.mock('../../account/models/user');
jest.mock('bcryptjs');
jest.mock('../../notifications/services/emailService');
jest.mock('../../authorization/services/accessTokenService');
jest.mock('../../authorization/services/refreshTokenService');
...
describe('authService', () => {
  ...
  describe('sendUserActivation', () => {
    it('sends activation email to inactive user', async () => {
      ...
      expect(user.save).toHaveBeenCalled();
      expect(sendActivationEmail).toHaveBeenCalledWith(user.email, {
